...
export type DataResponseStatusEnum =
  (typeof DataResponseStatusEnum)[keyof typeof DataResponseStatusEnum];
...
export function DataResponseFromJSONTyped(
  json: any,
...
export function DataResponseToJSONTyped(
