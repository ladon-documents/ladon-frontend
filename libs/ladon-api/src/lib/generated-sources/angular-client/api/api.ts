...
export const APIS = [ActionsService, AuthenticationService, BucketsService, ConverterService, DocumentsService, DownloadsService, NodeInfoService, PluginmanagerService, StreamService, TasksService, TransactionService, UsermanagerService, UsersService];
