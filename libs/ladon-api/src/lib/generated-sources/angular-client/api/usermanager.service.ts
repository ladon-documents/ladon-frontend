...
export class UsermanagerService {
	...
	public addAvatar(
		...
		let localVarPath = `/api/usermanager/users/${this.configuration.encodeParam({
			name: "userId",
			value: userId,
			in: "path",
			style: "simple",
	...
	public addPermissionForRole(
		...
		let localVarPath = `/api/usermanager/permissions/role/${this.configuration.encodeParam({
			name: "roleId",
			value: roleId,
			in: "path",
			style: "simple",
	...
	public addPermissionForUser(
		...
		let localVarPath = `/api/usermanager/permissions/user/${this.configuration.encodeParam({
			name: "userId",
			value: userId,
			in: "path",
			style: "simple",
	...
	public addRoleForUser(
		...
		let localVarPath = `/api/usermanager/roles/user/${this.configuration.encodeParam({
			name: "userId",
			value: userId,
			in: "path",
			style: "simple",
	...
	public deleteRole(
		...
		let localVarPath = `/api/usermanager/roles/${this.configuration.encodeParam({
			name: "roleId",
			value: roleId,
			in: "path",
			style: "simple",
	...
	public getLoginLogs(
		...
		let localVarPath = `/api/usermanager/logs/login/${this.configuration.encodeParam({
			name: "userId",
			value: userId,
			in: "path",
			style: "simple",
	...
	public getUsersForRole(
		...
		let localVarPath = `/api/usermanager/users/role/${this.configuration.encodeParam({
			name: "roleId",
			value: roleId,
			in: "path",
			style: "simple",
	...
	public removePermission(
		...
		let localVarPath = `/api/usermanager/permissions/${this.configuration.encodeParam({
			name: "permissionId",
			value: permissionId,
			in: "path",
			style: "simple",
	...
	public setCredentials(
		...
		let localVarPath = `/api/usermanager/user/${this.configuration.encodeParam({
			name: "userId",
			value: userId,
			in: "path",
			style: "simple",
