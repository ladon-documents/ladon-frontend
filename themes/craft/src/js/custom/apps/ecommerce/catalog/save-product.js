...
var KTAppEcommerceSaveProduct = (function () {
	...
	const initQuill = () => {
		...
		const elements = ["#kt_ecommerce_add_product_description", "#kt_ecommerce_add_product_meta_description"];
	...
	const initTagify = () => {
		...
		const elements = ["#kt_ecommerce_add_product_category", "#kt_ecommerce_add_product_tags"];
