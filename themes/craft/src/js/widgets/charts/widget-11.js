...
var KTChartsWidget11 = (function () {
	...
	return {
		init: function () {
			var chart1Data = [
				16, 19, 19, 16, 16, 14, 15, 15, 17, 17, 19, 19, 18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 20,
				20, 22,
			];
			initChart(chart1, "#kt_charts_widget_11_tab_1", "#kt_charts_widget_11_chart_1", chart1Data, false);

			var chart2Data = [
				18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22, 15, 18, 18, 17, 17, 15, 15, 17, 17,
				19, 17,
			];
			initChart(chart2, "#kt_charts_widget_11_tab_2", "#kt_charts_widget_11_chart_2", chart2Data, false);

			var chart3Data = [
				17, 20, 20, 19, 19, 17, 17, 19, 19, 21, 21, 19, 19, 21, 21, 18, 18, 16, 17, 17, 19, 19, 21, 21, 19, 19, 17, 17,
				18, 18,
			];
