...
define(["exports", "@form-validation/core", "@form-validation/plugin-excluded"], function (t, e, n) {
	"use strict";
	var i = function (t, e) {
		return (
			(i =
			...
			return (
				...
				(e.prototype.install = function () {
					...
					this.core.registerPlugin(
						e.EXCLUDED_PLUGIN,
						this.opts.isFieldExcluded ? new n.Excluded({ excluded: this.opts.isFieldExcluded }) : new n.Excluded()
					);
				...
				(e.prototype.goToStep = function (t) {
					var e, n;
					this.isEnabled &&
						(s(this.steps[this.currentStep], (((e = {})[this.opts.activeStepClass] = !1), e)),
