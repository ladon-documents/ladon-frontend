					...
					return (
						...
						(e.prototype.validateElement = function (e, t) {
							...
							if (this.filter.execute("element-ignored", !1, [e, t, i]))
								return (
									this.emit("core.element.ignored", { element: t, elements: i, field: e }), Promise.resolve("Ignored")
								);
						...
						(n.prototype.handleClickEvent = function (e) {
							...
							if (((this.isButtonClicked = !0), t instanceof HTMLElement))
								if (this.opts.aspNetButton && !0 === this.isFormValid);
									...
									n &&
										i &&
										(this.hiddenClickedEle.setAttribute("name", n), this.hiddenClickedEle.setAttribute("value", i)),
										this.validateForm(e);
								}
						}),
						...
						validate: function (e) {
							...
							if (c) {
								...
								var C = F.length > 0 ? (F[0].length <= 2 && /^\d+$/.test(F[0]) ? parseInt(F[0], 10) : -1) : 0,
									_ = F.length > 1 ? (F[1].length <= 2 && /^\d+$/.test(F[1]) ? parseInt(F[1], 10) : -1) : 0,
									I = F.length > 2 ? (F[2].length <= 2 && /^\d+$/.test(F[2]) ? parseInt(F[2], 10) : -1) : 0;
								if (-1 === C || -1 === _ || -1 === I) return l;
								if (I < 0 || I > 60) return l;
								if (C < 0 || C >= 24 || (u && C > 12)) return l;
								if (_ < 0 || _ > 59) return l;
								A.setHours(m && "PM" === m.toUpperCase() && C < 12 ? C + 12 : C), A.setMinutes(_), A.setSeconds(I);
							}
							...
							switch (!0) {
								...
								case !!j && !!k:
									return {
										...
										meta: { date: A },
										valid: A.getTime() <= P.getTime() && A.getTime() >= N.getTime(),
									};
								default:
									return { message: "".concat(s), meta: { date: A }, valid: !0 };
							}
						},
					};
				}),
					...
					return {
						validate: function (t) {
							...
							return {
								message:
									n.message ||
									(t.l10n ? ("upper" === i ? t.l10n.stringCase.upper : t.l10n.stringCase.default) : n.message),
