	...
	o = (function (e) {
		...
		return (
			(function (e, t) {
				...
				n(e, t), (e.prototype = null === t ? Object.create(t) : ((l.prototype = t.prototype), new l()));
			})(t, e),
			...
			(t.prototype.handleElementValidated = function (e) {
				...
				if (("checkbox" === t || "radio" === t) && e.elements.length > 1 && i(e.element, "form-check-input")) {
					var n = e.element.parentElement;
					i(n, "form-check") && i(n, "form-check-inline") && l(n, { "is-invalid": !e.valid, "is-valid": e.valid });
				}
			}),
			...
			(t.prototype.onMessagePlaced = function (e) {
				...
				var t = e.element.parentElement;
				if (i(t, "input-group")) return t.appendChild(e.messageElement), void l(t, { "has-validation": !0 });
				var n = e.element.getAttribute("type");
				("checkbox" !== n && "radio" !== n) ||
