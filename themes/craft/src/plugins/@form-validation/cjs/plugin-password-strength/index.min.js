...
var a = (function (t) {
	...
	return (
		(function (t, a) {
			...
			e(t, a), (t.prototype = null === a ? Object.create(a) : ((o.prototype = a.prototype), new o()));
		})(a, t),
		(a.prototype.install = function () {
			...
			this.core.registerValidator(a.PASSWORD_STRENGTH_VALIDATOR, this.validatePassword),
				...
				this.core.addField(this.opts.field, {
					validators:
						((t = {}),
						(t[a.PASSWORD_STRENGTH_VALIDATOR] = { message: this.opts.message, minimalScore: this.opts.minimalScore }),
						t),
				});
		}),
