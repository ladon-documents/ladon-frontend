		...
		return (
			...
			(t.prototype.onIconPlaced = function (e) {
				...
				if ("checkbox" === t || "radio" === t) {
					...
					r(e.iconElement, { "fv-plugins-icon-check": !0 }), n.parentElement.insertBefore(e.iconElement, n.nextSibling);
				}
			}),
			(t.prototype.onMessagePlaced = function (e) {
				...
				if (("checkbox" === t || "radio" === t) && n > 1) {
					...
					o(r, t) && o(r, "ui") && r.parentElement.insertBefore(e.messageElement, r.nextSibling);
				}
			}),
			t
		);
