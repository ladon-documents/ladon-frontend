...
t.exports = (function () {
			...
			return (
				...
				(e.prototype.validateElement = function (e, t) {
					...
					if (this.filter.execute("element-ignored", !1, [e, t, i]))
						return this.emit("core.element.ignored", { element: t, elements: i, field: e }), Promise.resolve("Ignored");
					...
					return this.waterfall(o)
						...
						.catch(function (r) {
							return n.emit("core.element.notvalidated", { element: t, elements: i, field: e }), Promise.resolve(r);
						});
				}),
				(e.prototype.executeValidator = function (e, t, n, i) {
					...
					if (!this.filter.execute("field-should-validate", !0, [e, t, l, n]))
						return (
							this.emit("core.validator.notvalidated", { element: t, elements: o, field: e, validator: n }),
							Promise.resolve("NotValidated")
						);
					this.emit("core.validator.validating", { element: t, elements: o, field: e, validator: n });
					var d = s().validate({ element: t, elements: o, field: e, l10n: this.localization, options: i, value: l });
					if ("function" == typeof d.then)
						return d.then(function (i) {
							var a = r.normalizeResult(e, n, i);
							return (
								r.emit("core.validator.validated", { element: t, elements: o, field: e, result: a, validator: n }),
								a.valid ? "Valid" : "Invalid"
							);
						});
					var c = this.normalizeResult(e, n, d);
					return (
						this.emit("core.validator.validated", { element: t, elements: o, field: e, result: c, validator: n }),
					...
					switch (n) {
						case "NotValidated":
							s.forEach(function (n) {
								return r.emit("core.validator.notvalidated", { element: t, elements: o, field: e, validator: n });
							}),
								this.emit("core.element.notvalidated", { element: t, elements: o, field: e });
							break;
						case "Validating":
							s.forEach(function (n) {
								return r.emit("core.validator.validating", { element: t, elements: o, field: e, validator: n });
							}),
				...
				(e.prototype.disableValidator = function (e, t) {
					...
					return (
						...
						this.emit("core.validator.disabled", { elements: n, field: e, formValidation: this, validator: t }),
						this
					);
				}),
				(e.prototype.enableValidator = function (e, t) {
					...
					return (
						...
						this.emit("core.validator.enabled", { elements: n, field: e, formValidation: this, validator: t }),
						this
					);
				}),
	...
	return (
		...
		(n.formValidation = function (e, t) {
			var n = Object.assign({}, { fields: {}, locale: "en_US", plugins: {}, init: function (e) {} }, t),
				r = new i(e, n.fields);
			return (
				...
				(n.prototype.parseElement = function (e) {
					for (
						...
						if (this.opts.html5Input)
							switch (!0) {
								case "minlength" === a:
									i.stringLength = Object.assign({}, { enabled: !0, min: parseInt(s, 10) }, i.stringLength);
									break;
								case "maxlength" === a:
									i.stringLength = Object.assign({}, { enabled: !0, max: parseInt(s, 10) }, i.stringLength);
									break;
								case "pattern" === a:
								...
								case "min" === a && "date" !== r && "range" !== r:
									i.greaterThan = Object.assign({}, { enabled: !0, min: parseFloat(s) }, i.greaterThan);
									break;
						...
						if (l && 4 === l.length) {
							...
							i[d] || (i[d] = {}),
								l[3]
									...
									: (!0 === i[d].enabled && !1 === i[d].enabled) || (i[d].enabled = "" === s || "true" === s);
						}
					}
					return { validators: i };
				}),
			...
			return (
				...
				(i.prototype.onEnabled = function () {
					this.messages.forEach(function (e, t, i) {
						n(t, { "fv-plugins-message-container--enabled": !0, "fv-plugins-message-container--disabled": !1 });
					});
				}),
				(i.prototype.onDisabled = function () {
					this.messages.forEach(function (e, t, i) {
						n(t, { "fv-plugins-message-container--enabled": !1, "fv-plugins-message-container--disabled": !0 });
					});
				}),
			...
			return (
							...
							(this.core.registerPlugin(
								...
								new t.Message({
									...
									container: function (e, i) {
										var r = "string" == typeof n.opts.rowSelector ? n.opts.rowSelector : n.opts.rowSelector(e, i),
											a = o(i, r);
				...
				(r.prototype.onEnabled = function () {
					...
					i(this.core.getFormElement(), (((e = {})[this.opts.formClass] = !0), e)),
						this.opts.defaultMessageContainer && this.core.enablePlugin(r.MESSAGE_PLUGIN);
				}),
				(r.prototype.onDisabled = function () {
					var e;
					i(this.core.getFormElement(), (((e = {})[this.opts.formClass] = !1), e)),
						this.opts.defaultMessageContainer && this.core.disablePlugin(r.MESSAGE_PLUGIN);
				}),
				...
				(r.prototype.prepareElementContainer = function (e, t) {
					var n,
						r = "string" == typeof this.opts.rowSelector ? this.opts.rowSelector : this.opts.rowSelector(e, t),
						a = o(t, r);
					a !== t &&
		...
		t = (function (t) {
			...
			return (
				...
				(n.prototype.exceedThreshold = function (e, t) {
					...
					return (
						-1 !== ["button", "checkbox", "file", "hidden", "image", "radio", "reset", "submit"].indexOf(i) ||
		...
		(Re.emailAddress = function () {
			return {
				validate: function (i) {
					...
					var r = Object.assign({}, { multiple: !1, requireGlobalDomain: !1, separator: /[,;]/ }, e(i.options)),
		...
		(at.ip = function () {
			return {
				validate: function (t) {
					...
					switch (!0) {
						case n.ipv4 && !n.ipv6:
							return { message: t.l10n ? n.message || t.l10n.ip.ipv4 : n.message, valid: i.test(t.value) };
						case !n.ipv4 && n.ipv6:
							return { message: t.l10n ? n.message || t.l10n.ip.ipv6 : n.message, valid: r.test(t.value) };
						case n.ipv4 && n.ipv6:
						default:
							return {
			...
			return {
				validate: function (i) {
					...
					return t(a, { crossDomain: r.crossDomain, headers: r.headers, method: r.method, params: o })
						.then(function (e) {
							return Promise.resolve({ message: e.message, meta: e, valid: "true" === "".concat(e[r.validKey]) });
						})
						.catch(function (e) {
		...
		(jt.stringCase = function () {
			return {
				validate: function (t) {
					...
					return {
						message:
							n.message || (t.l10n ? ("upper" === i ? t.l10n.stringCase.upper : t.l10n.stringCase.default) : n.message),
...
var Bt = zt.exports,
	...
	$t = r.algorithms,
	Xt = r.utils;
export { Zt as Plugin, $t as algorithms, Gt as formValidation, Yt as plugins, Xt as utils, qt as validators };
