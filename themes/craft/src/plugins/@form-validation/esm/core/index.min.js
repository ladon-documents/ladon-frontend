...
var t = (function () {
	...
	return (
		...
		(e.prototype.executeValidator = function (e, t, i, r) {
			...
			var d = a().validate({ element: t, elements: s, field: e, l10n: this.localization, options: r, value: o });
	...
	s = {
		call: function (e, t) {
			...
			if ("string" == typeof e) {
				...
				for (var r = i.split("."), n = r.pop(), s = window, l = 0, a = r; l < a.length; l++) {
					s = s[a[l]];
				}
		...
		isValidDate: function (e, t, i, r) {
			...
			if (
				i <= 0 ||
				i > [31, e % 400 == 0 || (e % 100 != 0 && e % 4 == 0) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][t - 1]
			)
				return !1;
			if (!0 === r) {
				var n = new Date(),
					...
					l = n.getMonth(),
					a = n.getDate();
				return e < s || (e === s && t - 1 < l) || (e === s && t - 1 === l && i < a);
			}
			return !0;
		},
