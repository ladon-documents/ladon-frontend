...
var o = (function (t) {
	function o(e) {
		...
		return (
			(o.opts = Object.assign({}, { minimalScore: 3, onValidated: function () {} }, e)),
	...
	return (
		...
		(o.prototype.install = function () {
			var t;
			this.core.registerValidator(o.PASSWORD_STRENGTH_VALIDATOR, this.validatePassword),
				this.core.on("core.validator.validated", this.validatorValidatedHandler),
				this.core.addField(this.opts.field, {
					validators:
						((t = {}),
						(t[o.PASSWORD_STRENGTH_VALIDATOR] = { message: this.opts.message, minimalScore: this.opts.minimalScore }),
						t),
				});
		}),
