	...
	r = (function (e) {
		...
		return (
			...
			(t.prototype.install = function () {
				...
				var i = void 0 === window[t.LOADED_CALLBACK] ? function () {} : window[t.LOADED_CALLBACK];
					...
					var a = {
							...
							callback: function () {
								"" === e.opts.backendVerificationUrl &&
									((e.captchaStatus = "Valid"), e.core.updateFieldStatus(t.CAPTCHA_FIELD, "Valid"));
							},
							"error-callback": function () {
								(e.captchaStatus = "Invalid"), e.core.updateFieldStatus(t.CAPTCHA_FIELD, "Invalid");
							},
							"expired-callback": function () {
								(e.captchaStatus = "NotValidated"), e.core.updateFieldStatus(t.CAPTCHA_FIELD, "NotValidated");
							},
			...
			(t.prototype.onResetField = function (e) {
				if (e.field === t.CAPTCHA_FIELD && this.widgetIds.has(this.opts.element)) {
			...
			(t.DEFAULT_OPTIONS = { backendVerificationUrl: "", badge: "bottomright", size: "normal", theme: "light" }),
