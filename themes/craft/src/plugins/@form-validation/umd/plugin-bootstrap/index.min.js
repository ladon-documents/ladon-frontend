...
!(function (e, n) {
	"object" == typeof exports && "undefined" != typeof module
		? (module.exports = n(require("@form-validation/core"), require("@form-validation/plugin-framework")))
		: "function" == typeof define && define.amd
		? define(["@form-validation/core", "@form-validation/plugin-framework"], n)
		: (((e = "undefined" != typeof globalThis ? globalThis : e || self).FormValidation = e.FormValidation || {}),
		  ...
		  (e.FormValidation.plugins.Bootstrap = n(e.FormValidation, e.FormValidation.plugins)));
})(this, function (e, n) {
	"use strict";
	var t = function (e, n) {
		return (
	...
	return (function (e) {
		...
		return (
			...
			(n.prototype.onIconPlaced = function (e) {
				...
				i(n, "input-group") && n.parentElement.insertBefore(e.iconElement, n.nextSibling);
