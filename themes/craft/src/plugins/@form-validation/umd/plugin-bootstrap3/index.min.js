...
!(function (e, t) {
	"object" == typeof exports && "undefined" != typeof module
		...
		: (((e = "undefined" != typeof globalThis ? globalThis : e || self).FormValidation = e.FormValidation || {}),
		  ...
		  (e.FormValidation.plugins.Bootstrap3 = t(e.FormValidation, e.FormValidation.plugins)));
})(this, function (e, t) {
	"use strict";
	var o = function (e, t) {
		return (
	...
	return (function (e) {
		...
		return (
			...
			(t.prototype.onIconPlaced = function (e) {
				...
				r(t, "input-group") && t.parentElement.insertBefore(e.iconElement, t.nextSibling);
				var o = e.element.getAttribute("type");
				if ("checkbox" === o || "radio" === o) {
					var i = t.parentElement;
					r(t, o)
						? t.parentElement.insertBefore(e.iconElement, t.nextSibling)
						: r(t.parentElement, o) && i.parentElement.insertBefore(e.iconElement, i.nextSibling);
				}
			}),
			t
		);
