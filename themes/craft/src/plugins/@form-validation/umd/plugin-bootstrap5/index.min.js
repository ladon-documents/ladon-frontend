		...
		return (
			...
			(t.prototype.handleElementValidated = function (e) {
				...
				if (("checkbox" === t || "radio" === t) && e.elements.length > 1 && o(e.element, "form-check-input")) {
					...
					o(n, "form-check") && o(n, "form-check-inline") && i(n, { "is-invalid": !e.valid, "is-valid": e.valid });
				}
			}),
			...
			(t.prototype.onMessagePlaced = function (e) {
				...
				var t = e.element.parentElement;
				if (o(t, "input-group")) return t.appendChild(e.messageElement), void i(t, { "has-validation": !0 });
				var n = e.element.getAttribute("type");
				("checkbox" !== n && "radio" !== n) ||
