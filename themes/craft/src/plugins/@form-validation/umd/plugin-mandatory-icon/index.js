(function (global, factory) {
	typeof exports === "object" && typeof module !== "undefined"
		...
		: ((global = typeof globalThis !== "undefined" ? globalThis : global || self),
		  ...
		  (global.FormValidation.plugins.MandatoryIcon = factory(global.FormValidation))));
})(this, function (core) {
	"use strict";
	...
	var MandatoryIcon = /** @class */ (function (_super) {
			...
			if (validators && validators["notEmpty"] && validators["notEmpty"].enabled !== false && elements.length) {
				...
				for (var _i = 0, elementArray_1 = elementArray; _i < elementArray_1.length; _i++) {
					...
					if (this.core.getElementValue(e.field, ele) === "") {
						// Add required icon
						classSet(e.iconElement, ((_a = {}), (_a[this.opts.icon] = this.isEnabled), _a));
					}
				}
			}
		...
		MandatoryIcon.prototype.updateIconClasses = function (ele, status) {
			...
			if (
				...
				classSet(icon, ((_a = {}), (_a[this.removedIcons[status]] = false), (_a[this.opts.icon] = false), _a));
			}
		};
		MandatoryIcon.prototype.onIconSet = function (e) {
			...
			if (
				(e.status === "NotValidated" && this.core.getElementValue(e.field, e.element) === "") ||
				e.status === "Ignored"
			) {
