...
!(function (t, o) {
	...
	return (function (t) {
		function e(o) {
			...
			return (
				(e.opts = Object.assign({}, { minimalScore: 3, onValidated: function () {} }, o)),
		...
		return (
			...
			(e.prototype.install = function () {
				var t;
				this.core.registerValidator(e.PASSWORD_STRENGTH_VALIDATOR, this.validatePassword),
					this.core.on("core.validator.validated", this.validatorValidatedHandler),
					this.core.addField(this.opts.field, {
						validators:
							((t = {}),
							(t[e.PASSWORD_STRENGTH_VALIDATOR] = { message: this.opts.message, minimalScore: this.opts.minimalScore }),
							t),
					});
			}),
			(e.prototype.uninstall = function () {
				this.core.off("core.validator.validated", this.validatorValidatedHandler),
					this.core.disableValidator(this.opts.field, e.PASSWORD_STRENGTH_VALIDATOR);
			}),
			(e.prototype.onEnabled = function () {
				this.core.enableValidator(this.opts.field, e.PASSWORD_STRENGTH_VALIDATOR);
			}),
