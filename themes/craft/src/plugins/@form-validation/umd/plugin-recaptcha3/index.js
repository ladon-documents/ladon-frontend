(function (global, factory) {
	typeof exports === "object" && typeof module !== "undefined"
		...
		: ((global = typeof globalThis !== "undefined" ? globalThis : global || self),
		  ...
		  (global.FormValidation.plugins.Recaptcha3 = factory(global.FormValidation))));
})(this, function (core) {
	"use strict";
    ...
    ***************************************************************************** */
	...
	var Recaptcha3 = /** @class */ (function (_super) {
		...
		Recaptcha3.prototype.install = function () {
			...
			var loadPrevCaptcha =
				typeof window[Recaptcha3.LOADED_CALLBACK] === "undefined" ? function () {} : window[Recaptcha3.LOADED_CALLBACK];
										...
										.then(function (token) {
											...
											fetch(_this.opts.backendVerificationUrl, {
												...
												.then(function (response) {
													var isValid =
														"".concat(response.success) === "true" && response.score >= _this.opts.minimumScore;
													resolve({
