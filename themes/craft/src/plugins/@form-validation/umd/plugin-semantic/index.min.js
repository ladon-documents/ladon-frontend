...
!(function (e, t) {
	"object" == typeof exports && "undefined" != typeof module
		? (module.exports = t(require("@form-validation/core"), require("@form-validation/plugin-framework")))
		...
		: (((e = "undefined" != typeof globalThis ? globalThis : e || self).FormValidation = e.FormValidation || {}),
		  ...
		  (e.FormValidation.plugins.Semantic = t(e.FormValidation, e.FormValidation.plugins)));
})(this, function (e, t) {
	"use strict";
	var n = function (e, t) {
		return (
		...
		return (
			...
			(t.prototype.onIconPlaced = function (e) {
				...
				if ("checkbox" === t || "radio" === t) {
					...
					o(e.iconElement, { "fv-plugins-icon-check": !0 }), n.parentElement.insertBefore(e.iconElement, n.nextSibling);
				}
			}),
			(t.prototype.onMessagePlaced = function (e) {
				...
				if (("checkbox" === t || "radio" === t) && n > 1) {
					...
					i(o, t) && i(o, "ui") && o.parentElement.insertBefore(e.messageElement, o.nextSibling);
				}
			}),
			t
		);
