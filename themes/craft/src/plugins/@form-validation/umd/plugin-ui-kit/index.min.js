...
!(function (o, t) {
	"object" == typeof exports && "undefined" != typeof module
		...
		: (((o = "undefined" != typeof globalThis ? globalThis : o || self).FormValidation = o.FormValidation || {}),
		  ...
		  (o.FormValidation.plugins.UiKit = t(o.FormValidation, o.FormValidation.plugins)));
})(this, function (o, t) {
	"use strict";
	var e = function (o, t) {
		return (
		...
		return (
			...
			(t.prototype.onIconPlaced = function (o) {
				...
				if ("checkbox" === t || "radio" === t) {
					...
					n(o.iconElement, { "fv-plugins-icon-check": !0 }), e.parentElement.insertBefore(o.iconElement, e.nextSibling);
				}
			}),
			t
		);
