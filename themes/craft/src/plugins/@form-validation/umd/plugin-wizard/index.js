(function (global, factory) {
	typeof exports === "object" && typeof module !== "undefined"
		? (module.exports = factory(require("@form-validation/core"), require("@form-validation/plugin-excluded")))
		: typeof define === "function" && define.amd
		? define(["@form-validation/core", "@form-validation/plugin-excluded"], factory)
		: ((global = typeof globalThis !== "undefined" ? globalThis : global || self),
		  ((global.FormValidation = global.FormValidation || {}),
		  (global.FormValidation.plugins = global.FormValidation.plugins || {}),
		  (global.FormValidation.plugins.Wizard = factory(global.FormValidation, global.FormValidation.plugins))));
    ...
    ***************************************************************************** */
	...
	var Wizard = /** @class */ (function (_super) {
		...
		Wizard.prototype.install = function () {
			...
			classSet(this.steps[0], ((_a = {}), (_a[this.opts.activeStepClass] = true), _a));
		...
		Wizard.prototype.goToStep = function (index) {
			...
			classSet(this.steps[this.currentStep], ((_a = {}), (_a[this.opts.activeStepClass] = false), _a));
			classSet(this.steps[index], ((_b = {}), (_b[this.opts.activeStepClass] = true), _b));
